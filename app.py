        ...
        <div class="container d-flex align-items-center">
            ...
            <div class="navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto fs-5 text-white">
                    ...
                    <li class="nav-item"><a class="nav-link" href="https://lexmoon-mal8.onrender.com/#about"><i class='bx bxs-user'></i>About</a></li>
                    <li class="nav-item"><a class="nav-link" href="https://lexmoon-mal8.onrender.com/#contact"><i class='bx bxs-envelope'></i>Contact</a></li>
                </ul>
            </div>
        </div>
    </nav>
